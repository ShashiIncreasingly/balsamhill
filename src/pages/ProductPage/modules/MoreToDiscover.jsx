  ...
  useEffect(() => {
    if (document.querySelector('#inc_cart_modal_1')) {
      if (addToCart) {
        ...
        // console.log(clientAddToCartResponse.entry);
        ...
        if (clientAddToCartResponse.entry.extendWarrantyPriceData) {
          ...
          root.render(
            <React.StrictMode>
              <ExtendedWarranty warrantyResponse={clientAddToCartResponse.entry.extendWarrantyPriceData} qty={clientAddToCartResponse.quantityAdded} />
            </React.StrictMode>,
          );
        }else {
          if (document.querySelector('.productAddToCartModal_cart-items-bg-wrapper__PUb66')) {
